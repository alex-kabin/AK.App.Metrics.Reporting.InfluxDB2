    ...
    // ReSharper restore CheckNamespace
{
    ...
    public static class MetricsInfluxDbReporterBuilder
    {
        ...
        /// <param name="bucket">The InfluxDB where metrics should be flushed.</param>
        ...
        internal static ILineProtocolClient CreateClient(
            ...
            httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Token", influxDbOptions.Token);
            
            return new DefaultLineProtocolClient(influxDbOptions, httpPolicy, httpClient);
        }
    }
}